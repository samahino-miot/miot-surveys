...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    // In a real app, we might send this to an error reporting service
  }
    ...
    if (this.state.hasError) {
      return this.props.fallback || (
        <div className="flex flex-col items-center justify-center min-h-[50vh] p-4 text-center bg-slate-50">
          ...
          <p className="text-slate-600 mb-4">Please try refreshing the page or contact support if the issue persists.</p>
